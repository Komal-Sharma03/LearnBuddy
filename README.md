# LearnBuddy
LearnBuddy is an AI-powered learning coach that helps students choose the right learning path based on their interests, current skills, and career goals. Instead of overwhelming students with countless course options, it creates a personalized roadmap using IBM watsonx.

## Problem Statement : Agentic AI for Personalized Course Pathways
...
The Objective :
Build an Agentic AI coach that interacts with students, understands their interests (like Frontend Development, Cybersecurity, UI/UX Design, etc.), assesses their current skill level, and dynamically builds a personalized course roadmap. The solution should:

- Personalized Learning Roadmaps – Generate structured curricula based on user interests, career aspirations, and current proficiency levels.
- Defined Duration – Estimated time to complete the module.
- Core Topics – A breakdown of essential concepts covered.
- Curated Resources – High-quality learning materials suggestions.
- Actionable Milestones – Specific projects or goals to validate learning.
​- Contextual AI Tips – Dynamic, module-specific guidance provided by the AI agent
